 ...
 * @version 0.2
 */
public class TestCLBanrisulCobrancaRegistrada {

	private ICampoLivre clBanrisulCobrancaRegistrada;
	...
	public void inicializa() {
		...
		clBanrisulCobrancaRegistrada = Factory4CampoLivre.create(titulo);
	...
	public void seOWriteRetornaOValorEsperado() {
		assertEquals(
				...
				"1110000000012283256304172", clBanrisulCobrancaRegistrada.write());
	}
